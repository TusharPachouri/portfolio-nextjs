              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <span className="font-bold text-blue-400 text-sm block">First Name</span>
                  ...
                  <div className="flex items-center">
                    <FaUser className="mr-3 text-blue-400" />
                    <div>
                      <span className="font-bold text-blue-400 text-sm block">Last Name</span>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <span className="font-bold text-blue-400 text-sm block">Age</span>
                  ...
                  <div className="flex items-center">
                    <FaBirthdayCake className="mr-3 text-blue-400" />
                    <div>
                      <span className="font-bold text-blue-400 text-sm block">Birthdate</span>
                      <span className="text-white font-medium">August 15, 2002</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <span className="font-bold text-blue-400 text-sm block">Languages</span>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <span className="font-bold text-blue-400 text-sm block">Residence</span>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <span className="font-bold text-blue-400 text-sm block">Phone</span>
                      <span className="text-white font-medium">+91-8218504473</span>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <FaEnvelope className="mr-3 text-blue-400" />
                    <div>
                      <span className="font-bold text-blue-400 text-sm block">Email</span>
                      <span className="text-white font-medium">tusharpachouri@gmail.com</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <span className="font-bold text-blue-400 text-sm block">Freelance</span>
                  ...
                  <div className="flex items-center">
                    <FaBriefcase className="mr-3 text-blue-400" />
                    <div>
                      <span className="font-bold text-blue-400 text-sm block">Experience</span>
                ...
                <div className="flex items-center">
                  <FaMapMarkerAlt className="mr-3 text-blue-400" />
                  <div>
                    <span className="font-bold text-blue-400 text-sm block">Address</span>
                    <span className="text-white font-medium">
                      9a/632, Murshadpur, Sadar Bazar, Mathura, 281001, 
                      Uttar Pradesh, India
                    </span>
                  </div>
                </div>
            ...
            <div className="bg-gray-900/60 rounded-lg p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { icon: FaCloudDownloadAlt, number: "503+", title: "Files Downloaded" },
